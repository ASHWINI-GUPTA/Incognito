...
namespace Incognito.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,Text,SentTime")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,Text,SentTime")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
